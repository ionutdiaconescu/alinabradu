...
const Home = () => {
  return (
    <div
      id="home"
      className="relative flex flex-col md:flex-row h-screen w-screen items-center justify-center gap-5 top-[5rem] md:top-[2rem] "
    >
      <div className=" ">
        <Image
          src="/hero-img.png"
          ...
          height={500}
          alt="home-background"
          className="object-cover md:h-[20rem] md:w-[30rem] h-[10rem] w-[15rem]"
        />
      </div>
      {/* --------------------TEXT-------------------------------- */}
      <div className=" rounded-2xl w-[20rem] md:w-[40rem] border-4 border-bray-500/40 drop-shadow-2xl backdrop-blur-md bg-gray-300/30  mt-[2rem] md:mt-0 md:p-10 max-w-[550px] md:max-w-[600px] md:space-y-[20px] text-center">
        ...
        <p className="text-sm p-2 md:text-lg md:p-0 text-center font-semibold md:text-start">
          ...
          rețete secrete, nici puteri magice . Cred în puterea oamenilor de a se
          autodepășiri, atât din experiența proprie cât și din experiența
          ...
          împlinire aduce înțelegerea de sine și depasirea intru-un mod sănătos
          a situatiililor personale de viață .
        </p>
      </div>

    ...
    <>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-center md:justify-center gap-[30px] shadow-2xl md:p-4 rounded-3xl backdrop-blur-md bg-gray-400/20">
          ...
          <div className="flex flex-col items-center justify-center text-lg bg-green-100/10 hover:bg-gray-400/10 transition-[4] backdrop-blur-md rounded-3xl w-[400px] h-auto gap-4 p-2 shadow-2xl border-4 border-gray-300/30">
            {/* titlu */}
            <h1 className="text-3xl font-extrabold text-center">
              Consiliere copii
            </h1>
          ...
          <div className="flex flex-col items-center justify-center text-lg hover:bg-gray-400/10 transition-[4] bg-green-100/10 backdrop-blur-md rounded-3xl w-[400px] h-auto gap-4 p-2 shadow-2xl border-4 border-gray-300/30">
            {/* titlu */}
            <h1 className="text-3xl font-extrabold text-center">
              Consiliere cupluri
            </h1>

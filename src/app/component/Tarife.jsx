  ...
  return (
    <>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-center md:justify-around gap-[60px] shadow-2xl md:p-4 rounded-3xl backdrop-blur-md bg-slate-300/20">
          <div className="flex flex-col items-center justify-center text-lg bg-gray-300/20 backdrop-blur-md rounded-3xl w-[400px] h-auto gap-4 p-2 shadow-2xl border-4 border-gray-300/30">
            {/* titlu */}
            ...
            <div className="flex flex-col space-y-[10px]">
              <div className="flex items-center justify-center">
                <FaCheckSquare className="text-3xl text-green-500 drop-shadow-2xl mr-4 border-2 border-gray-500/10 rounded-2xl" />
              ...
              <div className="flex items-center justify-center">
                <FaCheckSquare className="text-3xl text-green-500 mr-4 border-2 border-gray-500/10 rounded-2xl" />
                <p className="text-center w-[250px]">
          ...
          <div className="flex flex-col items-center justify-center text-lg bg-gray-300/20 backdrop-blur-md rounded-3xl w-[400px] h-auto gap-4 p-2 shadow-2xl border-4 border-gray-300/30">
            ...
            <div className="flex flex-col space-y-[10px]">
              <div className="flex items-center justify-center">
                <FaCheckSquare className="text-3xl text-green-500 mr-4 border-gray-500/10 rounded-2xl border-2" />
                <p className="text-center w-[250px]">
